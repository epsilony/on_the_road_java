 ...
 * 
 */
public class GetAllBeansOfContext {

    public static List<Object> getAllBeans(ApplicationContext context) {
        String[] beanDefinitionNames = context.getBeanDefinitionNames();
        ArrayList<Object> result = new ArrayList<>(beanDefinitionNames.length);
    ...
    public static void main(String[] args) {
        ...
        List<Object> allBeans = getAllBeans(context);
